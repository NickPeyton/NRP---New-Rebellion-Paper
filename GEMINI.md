...
At the start of each session, check the current branch. If not on a branch containing 'gemini', switch to one. If one does not exist, create it and set the remote up to track it.
