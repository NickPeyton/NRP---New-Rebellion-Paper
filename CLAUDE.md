...
Do not change files I have not asked you to change.

Do not destroy data.

Make sure you use the .venv when you test things.

Whenever you add or modify a piece of code, edit code_description.md accordingly.
...
Always tell me what a script will do before running it if it writes or deletes anything.
