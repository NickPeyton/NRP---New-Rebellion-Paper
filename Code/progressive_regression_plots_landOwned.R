...
ggsave("Output/Images/Graphs/muster_progressive_coefficients_landOwned.png",
...
ggsave("Output/Images/Graphs/primary_progressive_coefficients_landOwned.png",
...
ggsave("Output/Images/Graphs/seats_progressive_coefficients_landOwned.png",
    plot = seat_progressive_plot,
    width = 12, height = 8, dpi = 300
)

cat("\nProgressive control regression plots (landOwned) created successfully!\n")
cat("- Output/Images/Graphs/muster_progressive_coefficients_landOwned.png\n")
cat("- Output/Images/Graphs/primary_progressive_coefficients_landOwned.png\n")
cat("- Output/Images/Graphs/seats_progressive_coefficients_landOwned.png\n")
