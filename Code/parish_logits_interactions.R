...
raw_labels <- c(
  "ln(Land × InvDist)", "ln(Small Land × InvDist)", "ln(Large Land × InvDist)", "ln(Tithe × InvDist)",
...
pc_labels <- c(
  "ln(Land × InvDist / Pop)", "ln(Small Land × InvDist / Pop)", "ln(Large Land × InvDist / Pop)", "ln(Tithe × InvDist / Pop)",
  "ln(Lay Subsidy)", "Wet 1535", "Wet 1536",
  "ln(Population)", "Distance to Scotland"
)
...
sk_labels <- c(
  "ln(Land × InvDist / km²)", "ln(Small Land × InvDist / km²)", "ln(Large Land × InvDist / km²)", "ln(Tithe × InvDist / km²)",
  "ln(Lay Subsidy)", "Wet 1535", "Wet 1536",
  "ln(Population)", "Distance to Scotland"
)
