...
vars_to_plot <- c(
    "lown_sk", "loth_sk", "lti_sk", "lal_sk", "smHouse", "bigHouse", "friary",
...
ggsave("Output/Images/Graphs/muster_progressive_coefficients_ownOther.png",
...
ggsave("Output/Images/Graphs/primary_progressive_coefficients_ownOther.png",
...
ggsave("Output/Images/Graphs/seats_progressive_coefficients_ownOther.png",
    plot = seat_progressive_plot,
    width = 12, height = 8, dpi = 300
)

cat("\nProgressive control regression plots (ownOther) created successfully!\n")
cat("- Output/Images/Graphs/muster_progressive_coefficients_ownOther.png\n")
cat("- Output/Images/Graphs/primary_progressive_coefficients_ownOther.png\n")
cat("- Output/Images/Graphs/seats_progressive_coefficients_ownOther.png\n")
