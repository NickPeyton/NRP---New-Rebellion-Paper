...
cox3 <- coxph(Surv(primary_survival, primary) ~
    ...
    lowlands +
    mean_slope, data = rdf)
hideVars <- c("Constant", "X_COORD", "Y_COORD", "area", "uplands", "lowlands", "mean_slope")
stargazer(cox1, cox2, cox3,
    ...
    covariate.labels = c(
        "ln(Land Owned)", "ln(Tithe)", "ln(Alms)", "ln(Monastic Net Income)", "Friary", "Dry 1535", "Wet 1536", "Dry x Wet", "Percy", "ln(1535 Lay Subsidy Amount)", "ln(Population)"
    ),
